      ...
      <div className={containerClass} style={{backgroundImage: containerStyle}}>
        <div className="px-8 w-full flex mx-auto" >
          <div id="hero-label" className="pt-20 space-y-3  w-full justify-center text-center md:w-4/5 md:text-left">
            ...
            {
              button && <div className="pt-7 flex justify-center md:justify-start text-xl"><Link href={button.href} passHref><button className="p-2 rounded-md border-2 text-gray-200 font-bold hover:bg-lime-800 hover:bg-opacity-50">{button.label}</button></Link></div>
            }
          </div>
        </div>
      </div>
