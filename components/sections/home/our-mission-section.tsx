        ...
        <section className="px-5 pb-12 pt-10 md:px-8 md:pb-16 md:pt-16 lg:px-[64px] lg:pb-20 lg:pt-28">
            <div className="mx-auto w-full max-w-[1440px]">
                <div className="px-4 grid gap-6 lg:grid-cols-[1fr_1.35fr] lg:items-start lg:gap-10">
                    <p className="mx-auto hidden max-w-[680px] font-medium leading-[1.14] tracking-[-0.02em] text-black [font-size:clamp(22px,4vw,48px)] lg:mx-0 lg:block lg:text-left">{BADGE}</p>
                    <div className="space-y-5 lg:space-y-0">
                        ...
                        <h2 className="max-w-[660px] font-semibold leading-[1.35] tracking-[-0.02em] [font-size:clamp(16px,4vw,42px)] lg:hidden">{t('heading')}</h2>
                ...
                <div className="relative mt-5 overflow-hidden rounded-[14px] md:mt-8 md:rounded-[18px] lg:mt-12 lg:h-[446px] lg:rounded-[22px]">
                    ...
                    <p className="pointer-events-none absolute bottom-1 left-7 text-[48px] font-medium leading-none tracking-[-0.02em] text-white/45 md:left-10 md:text-[84px] lg:hidden">OUR MISSION</p>
                </div>

                <div className="mt-8 space-y-6 font-medium leading-[1.6] text-[#141414] [font-size:clamp(14px,4vw,44px)] px-4 md:px-11 lg:hidden">
                    <p>{paragraphs[0]}</p>
                    <p>{paragraphs[1]}</p>
                </div>
            </div>
