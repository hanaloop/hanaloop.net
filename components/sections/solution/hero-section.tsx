...
const relatedLinks: PlatformHeroRelatedLink[] = [
    ...
    { label: { ko: '기후 경영', en: 'Climate Strategy', es: 'Estrategia Climatica' }, href: '/solution', current: true },
];
...
export function SolutionHeroSection({ locale }: SolutionHeroSectionProps) {
    return (
        <PlatformHero
            locale={locale}
