...
export async function HanaAiWhyNeedSection() {
    const t = await getTranslations('HanaAiWhyNeed');
    ...
    return (
        <section className="pt-14 md:pt-20 lg:pt-[116px]" aria-label={t('sectionAriaLabel')}>
            ...
            <div className="relative w-full overflow-hidden">
                <div role="img" aria-label={t('imageAlt')} className="relative lg:h-[695px] bg-[url('/site/hana-ai/why-need-bg.png')] bg-center bg-cover">
