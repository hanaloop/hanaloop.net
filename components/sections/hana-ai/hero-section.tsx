...
const relatedLinks: PlatformHeroRelatedLink[] = [
    ...
    { label: { ko: 'Hana.eco AI', en: 'Hana.eco AI', es: 'Hana.eco AI' }, href: '/hana-ai', current: true },
...
export function HanaAiHeroSection({ locale }: HanaAiHeroSectionProps) {
    return (
        <PlatformHero
            locale={locale}
