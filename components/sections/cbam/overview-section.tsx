            ...
            <div className="mx-auto w-full max-w-[1440px] px-5 md:px-8 lg:px-11">
                ...
                <div className="mt-10 lg:hidden">
                    ...
                    <div className="mt-10 pt-1 lg:max-w-[700px] lg:flex-1">
                        ...
                        <p className="mt-4 text-[var(--color-text-subtle)] [font-size:clamp(16px,calc(14.27px+0.47vw),21px)] font-medium tracking-[-0.25px] md:mt-5 whitespace-pre-line">{t('solutionBody')}</p>
