        ...
        <section className="px-5 pb-14 pt-14 md:px-8 lg:px-0 lg:pb-[120px] lg:pt-[114px]" aria-label={t('sectionAriaLabel')}>
            <div className="mx-auto w-full max-w-[1440px] px-11">
                ...
                <div className="mt-10 lg:hidden">
                    <div className="pt-1 lg:max-w-[700px] lg:flex-1">
                        ...
                        <p className="mt-4 text-[16px] font-medium leading-[1.6] tracking-[-0.25px] text-black md:mt-5 md:text-[17px]">{t('whatBody')}</p>

                        <h3 className="mt-12 text-[28px] font-bold leading-[1.3] tracking-[-0.25px] text-black md:mt-14 md:text-[32px]">{t('solutionTitle')}</h3>
                        <p className="mt-4 text-[16px] font-medium leading-[1.6] tracking-[-0.25px] text-black md:mt-5 md:text-[17px]">{t('solutionBody')}</p>
                    ...
                    <div className="mt-10 overflow-hidden rounded-tl-[18px] rounded-br-[18px] lg:mt-[8px] lg:w-[min(957px,49.84vw,50vw)] lg:shrink-0">
                        <Image src="/images/revamp/cbam/overview-cars.png" alt={t('imageAlt')} width={957} height={707} className="h-auto w-full object-cover" sizes="(min-width: 1920px) 957px, (min-width: 1200px) 49.84vw, (min-width: 1024px) 50vw, 100vw" />
                    </div>
                </div>
            </div>
            ...
            <div className="mt-18 hidden items-center justify-between gap-10 lg:flex xl:pl-[calc((100vw-1440px)/2)]">
                <div className="pt-1 lg:max-w-[700px] lg:flex-1 pl-11">
                    ...
                    <p className="mt-6 text-[18px] font-medium leading-[1.65] tracking-[-0.25px] text-black">{t('whatBody')}</p>

                    <h3 className="mt-22 text-[36px] font-bold leading-[1.35] tracking-[-0.25px] text-black">{t('solutionTitle')}</h3>
                    <p className="mt-6 text-[18px] font-medium leading-[1.65] tracking-[-0.25px] text-black">{t('solutionBody')}</p>
                ...
                <div className="overflow-hidden rounded-tl-[18px] rounded-br-[18px] lg:w-[min(957px,50vw)] lg:shrink-0">
                    <Image src="/images/revamp/cbam/overview-cars.png" alt={t('imageAlt')} width={957} height={707} className="h-auto w-full object-cover" sizes="(min-width: 1920px) 957px, (min-width: 1024px) 50vw, 100vw" />
                </div>
            </div>
        </section>
    );
