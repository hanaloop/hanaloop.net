...
export const carbon_buddy: PageSection = {
  ...
  items : [
    {
      title : "Rapid Regulatory Insight and Response",
      description : "Generative AI enables swift comprehension and reaction to the latest regulations",
    },
    {
      title : "User-Friendly Data Analysis",
      description : "Machine Learning-based methods simplify data understanding and utilization",
    },
    {
      title : "Effortless Report Generation",
      description : "Instantly create necessary reports with ease in real time",
    },
  ]
}
...
export const why_need: PageSection = { 
  title: "Why Does Your Company Need to Manage Carbon?",
  items: [{
...
export const reliable: PageSection = {
  title: "Hana.eco: A trusted platform you can rely on!",
  subtitle: "Hana.eco is a leader in carbon management, being the first company to receive verification from Lloyd's Register (LRQA) for compliance with both the Korea Emissions Trading Scheme and the EU Carbon Border Adjustment Mechanism.",
  items: [{
      title: "Compliance with the EU CBAM",
...
export const features: PageSection = {
  title: "Manage your carbon emissions with Hana.eco",
  items: [{
      icon: "",
      title: "Carbon Accounting",
      description:
        "Quantify greenhouse gas emissions into CO2eq. Hana.eco provides  automation of data collection, report generation data analysis, and  anomaly detection for increased data accuracy."
    },
    {
      icon: "",
      title: "Collaboration",
      description: "Facilitate seamless collaboration among the company's environmental safety team, ESG strategy team, managers, practitioners, consultants, and verification auditors to enhance productivity.",
    },
    {
      icon: "",
      title: "Strategy",
    ...
    },
    {
      ...
      description: "To comprehensively assess your environmental impact, consider all three scopes of emissions: Scope 1, Scope 2 , and Scope 3, indirect emissions across your entire value chain.",
    },
  ]
};

export const customers: PageSection = { 
  title: "The HanaLoop Net-Zero Network empowers customers, partners, and collaborators to accelerate their journey toward carbon neutrality",
  subtitle:"",
  items: [{
      title: "Emart",
