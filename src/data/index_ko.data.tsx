...
export const content = {
  ...
  section2_title: <div className="text-5xl mb-3">함께하는 고객사</div>,
  section2_subtitle: "",
  section3_title: "기업활동 중에 발생하는 온실가스, 제품의 탄소관리를 AI 기반 탄소관리 플랫폼 하나에코로 간편하게 관리하세요!",
  section3_link: <div><span className="font-bold text-white text-lg">하나에코 플랫폼 소개</span> </div>,
...
export const elements: DisplayItem[] = [
  {
    ...
    description: [
      <span key="1"><b>제품 관리</b></span>,
      <span key="2"><b>원부자재 공급 관리</b></span>,
      <span key="3"><b>CBAM 보고서 출력</b> </span>,
      <span key="3"><b>배출계수 제공</b> </span>
    ] 
  }, 
  {
    ...
    description: [
      <span key="1"><b>표준 보고서에서 요구되는 리포팅</b> </span>,
      <span key="2"><b>리스크 관리</b></span>,
      <span key="3"><b>시나리오 분석</b> </span>
    ] 
  },
  {
    title: "ESG & 스코프 3 관리",
    ...
    description: [
      <span key="1"><b>정성적인 데이터 관리</b></span>,
      <span key="2"><b>협력사 관리</b> </span>,
      <span key="3"><b>Scope 3용 산업 표준 배출계수 제공</b></span>,
    ] 
  },
  {
    title: "제품 탄소발자국 관리",
    ...
    description: [
      <span key="0"><b>지구 온난화 카테고리의 LCA 산정</b></span>,
      <span key="1"><b>공정과정 탄소 내재배출 산정</b> </span>,
      <span key="2"><b>원부자재 내재배출 관리</b> </span>,
      <span key="3"><b>비용 효율성 분석</b> </span>,
    ] 
  }, 
  {
    ...
    description: [
      <span key="0"><b>검증 수준 데이터 관리 </b></span>,
      <span key="1"><b>배출권 장부 관리 </b>  </span>,
      <span key="2"><b>배출량 목표 설정 및 배출 시나리오 분석</b></span>,
    ] 
  },
]
