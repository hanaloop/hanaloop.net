...
export const content = {
  ...
  hanaloop_body: `(주)하나루프는 함께 살아가는 지구 환경을 위해 하나의 발걸음을 시작하였습니다. 우리는 산업과 기업 환경에 필요한 맞춤형 제안과 안정적인 탄소 중립 매니지먼트 핵심 기술로 지속가능한 생태계를 구축하기 위해 디지털 환경을 구현합니다. 사람들이 환경을 위한 일에 더 자율적이고 보편적인 기술에 접근 가능하도록 환경과 산업에 필요한 디지털 혁신 기술을 개발하고 지속가능한 넷제로 환경을 개척하고 있습니다. 하나루프는 사람과 자연에게 이로운 디지털 기술 서비스로 모두의 삶이 지속가능하도록 하나의 연결로 더 큰 임팩트를 만들어가겠습니다.
  ...
  corevalues_body: <><ul>
  <li><b>SYNERGISTIC</b>한 협력으로</li>
  <li><b>BOLD</b>한 임팩트와 감동을 선사하는</li>
  <li><b>RELIABLE</b>한 파트너</li>
  </ul></>,
