...
export default function SectionBlock({
  ...
  return (
    ...
    >
      <div className="">
        {title && (
          <div className="text-5xl leading-[60px] font-bold flex items-center justify-center transition delay-150">
            ...
            <h2 className="font-semibold  inline transition delay-150">
              {title}
            </h2>
          </div>
        )}
